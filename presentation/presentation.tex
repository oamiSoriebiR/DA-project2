...
\begin{frame}{The Graph Class: Conceptual Decisions}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{DOT File Emission:} Added \texttt{emitDOTFile()} to export the graph to Graphviz format for visual debugging and presentation.
            \item \textbf{Degree Tracking:} Integrated degree management (\texttt{getIndegree()}) crucial for the \textit{Smallest-Degree-First} heuristic and the Simplify phase.
            \item \textbf{Mutable Priority Queue:} Integrated \texttt{MutablePriorityQueue} to efficiently extract minimum degree nodes during the simplification stack building.
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{"Free" Algorithm Strategy (T2.4)}
    \begin{itemize}
        \item \textbf{Priority-Based Hybrid Approach.}
        \item Replaces standard stack with a \textit{Smallest-Degree-First} priority queue.
        \item \textbf{Dynamic Impasse Resolution:}
        \begin{itemize}
            \item \textbf{High Density (Near-Clique):} Triggers Spilling.
            \item \textbf{Localized Clusters:} Triggers Splitting.
        \end{itemize}
        \item Prevents aggressive splitting of highly connected graphs and unnecessary spilling of easily splittable webs.
    \end{itemize}
\end{frame}
...
\begin{frame}{Challenging Aspects of Implementation}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Updating the interference graph dynamically without a full rebuild.
        \end{itemize}
